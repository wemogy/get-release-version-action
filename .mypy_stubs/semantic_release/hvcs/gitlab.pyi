...
class Gitlab(HvcsBase):
    ...
    def create_release(self, tag: str, release_notes: str, prerelease: bool = False) -> str: ...
    def edit_release_notes(self, release_id: str, release_notes: str) -> str: ...
    def create_or_update_release(self, tag: str, release_notes: str, prerelease: bool = False) -> str: ...
